...
public class StatAllocationModule {
	...
	private string[] statDescriptions = new string[6] {"Health Modifier","Energy Modifier", "Magical Damage Modifier",
						"Physical Damage Modifier","Haste and Critical Strike Modifier","All Damage Reduction Modifier"};
	private bool[] statSelections = new bool[6];

	public static int[] pointsToAllocate = new int[6];
	// Starting stat values for the chosen class
	private int[] baseStatPoints = new int[6];
